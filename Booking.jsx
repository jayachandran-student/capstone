import { createContent, useContent, useState, useEffect } from "react";
import PropTypes from "prop-types";

const CartContent = createContent({
  items: {},
  handleAddToCart: () => {},
  handleUpdateCart: () => {},
});
...
export function CartContentProvider({ children }) {
  ...
  return (
    <CartContent.Provider value={{ items, handleAddToCart, handleUpdateCart }}>
      {children}
    </CartContent.Provider>
  );
}

CartContentProvider.propTypes = {
